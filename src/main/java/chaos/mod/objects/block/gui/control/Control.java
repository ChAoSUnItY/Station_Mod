...
public abstract class Control {
	...
	public abstract void draw(int paramInt1, int paramInt2, FontRenderer fontRenderer);
	...
	public boolean onTheMouse(int mouseX, int mouseY) {
		return (mouseX >= this.locationX && mouseY >= this.locationY && this.locationX + this.width >= mouseX
