...
public class ControlCheckBox extends Control {
	...
	public void draw(int mouseX, int mouseY) {
		...
		drawRect(this.locationX + this.height - 1, this.locationY, this.locationX + this.height,
				this.locationY + this.height, -4144960);
		drawRect(this.locationX, this.locationY + this.height - 1, this.locationX + this.height,
				this.locationY + this.height, -4144960);
		if (this.check)
